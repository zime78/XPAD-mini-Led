...
| 자동 테스트 | Vitest 7개 파일, 38개 테스트 통과 — 창 역할, P1 고정값 강제, P2~P5 고유값 순차 로드·원래 프로필 복원, 미지원 코드 비노출, KeyInfo 해석, 편집 프로필/사용 프로필 분리, 연결 실패 시 키보드·일반 설정 잠금, 키 변경·앱 실행 선택, 기존 미디어 설정 승계, F16~F18 전용 라우팅, 백업 생성·최대 10개·정확 복원·손상/미지원 스키마 보호 |
